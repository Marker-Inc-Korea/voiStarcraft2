...
through `0074`, runs the runtime CTest contracts, then copies the blackboard
header and generates the embedded
identity header before compilation. The
schema-74 report includes pinned MicroMachine and `s2client-api` commits, every patch
