...
DEFAULT_MICROMACHINE_PARALLEL_OPERATIONS_INGAME_HUD_PATCH: Final[Path] = (
    REPO_ROOT
    / "integrations"
    / "micromachine"
    / "patches"
...
DEFAULT_MICROMACHINE_AUTHORITATIVE_BATTLEFIELD_OWNERSHIP_READINESS_PATCH: Final[
    Path
] = (
    REPO_ROOT
    / "integrations"
...
DEFAULT_MICROMACHINE_BATTLEFIELD_PROJECTION_REVIEW_CLOSURE_PATCH: Final[Path] = (
    REPO_ROOT
    / "integrations"
    / "micromachine"
    / "patches"
...
DEFAULT_MICROMACHINE_CONTEXTUAL_TRANSFER_CHOICE_PROJECTION_PATCH: Final[Path] = (
    REPO_ROOT
    / "integrations"
    / "micromachine"
    / "patches"
...
DEFAULT_MICROMACHINE_BOUNDED_TERMINAL_OPERATION_HUD_PATCH: Final[Path] = (
    REPO_ROOT
    / "integrations"
    / "micromachine"
    / "patches"
...
class MicroMachineBuildIdentityConfig:
    ...
    micromachine_authoritative_battlefield_ownership_readiness_patch: Path = (
        DEFAULT_MICROMACHINE_AUTHORITATIVE_BATTLEFIELD_OWNERSHIP_READINESS_PATCH
    )
...
def build_micromachine_build_identity(
    ...
    *,
    ...
    checksums = {
        ...
        "micromachine_authoritative_battlefield_ownership_readiness_patch_sha256": (
            _sha256_file(
                config.micromachine_authoritative_battlefield_ownership_readiness_patch
            )
        ),
    ...
    return {
        ...
        "paths": {
            ...
            "micromachine_authoritative_battlefield_ownership_readiness_patch": str(
                config.micromachine_authoritative_battlefield_ownership_readiness_patch
            ),
