...
| Gate | Result |
| --- | --- |
| Current Python suite | `2176 passed, 6386 subtests passed` in the local `dev + llm` environment |
...
| Clean patched build | Build identity schema `71`, `ok=true`, identity `sha256:91a613a6eed2cbcef1eb3adc0674dea0884a601b722c5f3367d5bf076fd2b5fc`, embedded build-input identity `sha256:95f7504183e50b69bc9820a3c21269e0512dd0aa5f8556e8f69ec87518570be1`, binary SHA-256 `41a911404652a15d0db7215ecbfe56b87e8f442cbe686dcac79c6d6297734d29`, source attestation SHA-256 `d3ae2317038d99daefeca37cd8002238039211e4e03f01db5d97d267939ad54b` |
